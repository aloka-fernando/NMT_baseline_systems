...
checkpoint='mbart50-ft-en-ta-run4'
...
for subDir in directories :
    ...
    if subDir.find('checkpoint-') != -1: 
        print(subDir)  
        fileOut = open('data/parallel-27.04.2021-ts-translated-run4-checkpoint-360000-r2.un.en-ta.ta', 'w', encoding='utf8')
        ...
        os.system('sacrebleu -tok "none" -s "none" data/parallel-27.04.2021-ts.un.si-en-ta.ta < data/parallel-27.04.2021-ts-translated-run4-checkpoint-360000-r2.un.en-ta.ta ')        
