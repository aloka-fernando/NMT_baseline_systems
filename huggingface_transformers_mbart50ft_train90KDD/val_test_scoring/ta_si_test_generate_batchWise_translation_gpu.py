...
print('Testset v1 Scores for {}'.format(checkpoint))

os.chdir('/userdirs/aloka/nmt_baseline_experiments/mbart50ft_huggingface_api')
#initialize tokenizer
tokenizer = MBart50TokenizerFast.from_pretrained(checkpoint, src_lang="ta_IN")


src_lines=[line.strip() for line in open('data/parallel-27.04.2021-ts.un.si-en-ta.ta', 'r', encoding='utf8')]
...
for subDir in directories :
    ...
    if subDir.find('checkpoint-') != -1: 
        print(subDir)  
        fileOut = open('data/parallel-27.04.2021-ts-translated-run1-checkpoint-370000-r2.un.ta-si.si', 'w', encoding='utf8')
        ...
        os.system('sacrebleu -tok "none" -s "none" data/parallel-27.04.2021-ts.un.si-en-ta.si < data/parallel-27.04.2021-ts-translated-run1-checkpoint-370000-r2.un.ta-si.si ')        
