...
checkpoint='mbart50-ft-ta-en-run1'
...
for subDir in directories :
    ...
    if subDir.find('checkpoint-') != -1: 
        print(subDir)  
        fileOut = open('data/parallel-27.04.2021-ts-translated-run1-checkpoint-370000-r2.un.ta-en.en', 'w', encoding='utf8')
        ...
        os.system('sacrebleu -tok "none" -s "none" data/parallel-27.04.2021-ts.un.si-en-ta.en < data/parallel-27.04.2021-ts-translated-run1-checkpoint-370000-r2.un.ta-en.en ')        
