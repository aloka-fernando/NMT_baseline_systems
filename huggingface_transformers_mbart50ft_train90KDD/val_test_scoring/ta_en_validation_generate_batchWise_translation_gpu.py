...
tokenizer = MBart50TokenizerFast.from_pretrained(checkpoint, src_lang="ta_IN", tgt_lang="en_XX")
...
for subDir in directories :
    ...
    if subDir.find('checkpoint-') != -1: 
        print(subDir)  
        fileOut = open('data/parallel-27.04.2021-tu-translated.un.ta-en.en', 'w', encoding='utf8')
        ...
        os.system('sacrebleu -tok "none" -s "none" data/parallel-27.04.2021-tu.un.si-en-ta.en < data/parallel-27.04.2021-tu-translated.un.ta-en.en ')        
