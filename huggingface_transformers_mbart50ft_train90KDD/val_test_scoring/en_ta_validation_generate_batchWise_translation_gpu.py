...
checkpoint='mbart50-ft-en-ta-run5'
...
tokenizer = MBart50TokenizerFast.from_pretrained(checkpoint, src_lang="en_XX", tgt_lang="ta_IN")
...
for subDir in directories :
    ...
    if subDir.find('checkpoint-') != -1: 
        print(subDir)  
        fileOut = open('data/parallel-27.04.2021-tu-translated.un.en-ta.ta', 'w', encoding='utf8')
        ...
        os.system('sacrebleu -tok "none" -s "none" data/parallel-27.04.2021-tu.un.si-en-ta.ta < data/parallel-27.04.2021-tu-translated.un.en-ta.ta ')        
