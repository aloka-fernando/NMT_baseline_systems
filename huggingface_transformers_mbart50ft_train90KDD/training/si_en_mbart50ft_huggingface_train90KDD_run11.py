...
#training data
train_data=[]
with open('data/parallel-27.04.2021-train90KDD.si-en-ta.si') as f1, open('data/parallel-27.04.2021-train90KDD.si-en-ta.en') as f2:
...
#Validationi data
valid_data=[]
with open('data/parallel-27.04.2021-tu.un.si-en-ta.si') as f1, open('data/parallel-27.04.2021-tu.un.si-en-ta.en') as f2:
    for src, tgt in zip(f1, f2):
      valid_data.append(
          {
              "translation": {
...
def data_collator(features:list):
  ...
  labels = [f["translation"]["en_XX"] for f in features]  
...
args = Seq2SeqTrainingArguments(output_dir='mbart50-ft-si-en-run11',
                        do_train=True,
                        do_eval=True,
                        ...
                        push_to_hub=False,
                        push_to_hub_model_id='mbart50-ft-si-en-run11')
...
tokenizer.save_pretrained('mbart50-ft-si-en-run11')
trainer.train()
#trainer.push_to_hub()
...
print('Time taken for training : {} hrs {} min {} sec'.format(days, hrs, mints))
