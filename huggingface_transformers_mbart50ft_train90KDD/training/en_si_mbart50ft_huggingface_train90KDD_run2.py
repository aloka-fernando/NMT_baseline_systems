...
#training data
train_data=[]
with open('data/parallel-27.04.2021-train90KDD.si-en-ta.en') as f1, open('data/parallel-27.04.2021-train90KDD.si-en-ta.si') as f2:
...
#Validationi data
valid_data=[]
with open('data/parallel-27.04.2021-tu.un.si-en-ta.en') as f1, open('data/parallel-27.04.2021-tu.un.si-en-ta.si') as f2:
    for src, tgt in zip(f1, f2):
      valid_data.append(
          {
              "translation": {
...
args = Seq2SeqTrainingArguments(output_dir='mbart50-ft-en-si-run2',
                        do_train=True,
                        do_eval=True,
                        ...
                        push_to_hub=False,
                        push_to_hub_model_id='mbart50-ft-en-si-run2')
...
tokenizer.save_pretrained('mbart50-ft-en-si-run2')
trainer.train()
#trainer.push_to_hub()
...
hrs = int((elapsedTime%86400)//60)
mints = int((elapsedTime%86400)%60)

print('Time taken for training : {} days {} hrs {} mints'.format(days, hrs, mints))
