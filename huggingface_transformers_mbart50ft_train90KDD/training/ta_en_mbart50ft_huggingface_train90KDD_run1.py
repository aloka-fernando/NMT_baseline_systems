...
#training data
train_data=[]
with open('data/parallel-27.04.2021-train90KDD.si-en-ta.ta') as f1, open('data/parallel-27.04.2021-train90KDD.si-en-ta.en') as f2:
...
#Validationi data
valid_data=[]
with open('data/parallel-27.04.2021-tu.un.si-en-ta.ta') as f1, open('data/parallel-27.04.2021-tu.un.si-en-ta.en') as f2:
    for src, tgt in zip(f1, f2):
      valid_data.append(
          {
              "translation": {
...
args = Seq2SeqTrainingArguments(output_dir='mbart50-ft-ta-en-run1',
                        do_train=True,
                        do_eval=True,
                        ...
                        push_to_hub=False,
                        push_to_hub_model_id='mbart50-ft-ta-en-run1')
...
tokenizer.save_pretrained('mbart50-ft-ta-en-run1')
trainer.train()
#trainer.push_to_hub()
